...
> [!IMPORTANT]
> **¡Operaciones 100% Locales!** Toda la conversión y manipulación de archivos se ejecuta en la CPU de tu propia computadora (usando `pdf-lib`, `pdf.js`, `jszip` y `mammoth.js`), asegurando que la privacidad de tus archivos sea siempre absoluta.
...
* **Imágenes a PDF:** Convierte y compagina múltiples imágenes en un único archivo PDF. Soporta arrastrar múltiples formatos (PNG, JPG, BMP, WEBP, GIF).
* **PDF a Imágenes:** Extrae todas las páginas de un PDF y las descarga como imágenes individuales (PNG o JPEG) dentro de un archivo comprimido **.ZIP**.
* **Firmar PDF:** Dibuja tu firma digital en un lienzo táctil o con ratón y colócala de manera interactiva sobre cualquier posición y página del PDF.
